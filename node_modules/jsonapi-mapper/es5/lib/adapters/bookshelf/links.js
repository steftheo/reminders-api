 ...
 */
function buildTop(baseUrl, type, queryParams, pag) {
    var obj = {
        self: baseUrl + '/' + inflection.pluralize(type)
    };
    // Add pagination if given
    if (pag)
        _.assign(obj, buildPagination(baseUrl, type, queryParams, pag));
    return obj;
}
 ...
 */
function buildPagination(baseUrl, type, query, pag) {
 ...
 */
function buildSelf(baseUrl, modelType, queryParams) {
    return {
        self: function (data) {
            var link = baseUrl + '/' +
...
function buildRelationship(baseUrl, modelType, relatedType, queryParams) {
    return {
        self: function (data) {
            var link = baseUrl + '/' +
                inflection.pluralize(modelType);
